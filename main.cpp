...
SoftwareSerial bth( bthTX , bthRX ); // TX  , RX
Servo S1 , S2 , S3 , S4;
String com;
...
void loop() {
  ...
  if(bth.available() > 0){
    ...
    if(com.startsWith("servo1")){                   // Z servo
    ...
    if(com.startsWith("servo2")){                   // X servo
    ...
    if(com.startsWith("servo3")){                     // Rotation Servo , Y servo
    ...
    if(com.startsWith("servo4")){                         // Gripper Servo
